from base.base_trainer import BaseTrainer, TrainValTensorBoard_visualize
import os, time
...
class PersistenceTrainer(BaseTrainer):
    def __init__(self, model, config):
        super(PersistenceTrainer, self).__init__(model, config)
    ...
    def trainModel(self, TrainGenerator, CVGenerator):
        ...
        self.callbacks.append(
            TrainValTensorBoard_visualize(self.config,
                                CVGenerator,
                                **self.args)
        )
...
def PersistenceTest(model, data, config):
    X_test, Y_test = data
